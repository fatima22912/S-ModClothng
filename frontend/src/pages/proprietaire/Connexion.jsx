...
export default function ConnexionProprietaire() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      if (reponse.role !== 'proprietaire') {
        setErreur("Ce compte n'est pas un compte propriétaire.");
        return;
      }
      connecter(reponse);
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-rose-light px-4">
      <form onSubmit={handleSubmit} className="w-full max-w-sm rounded-2xl bg-white p-8 shadow-lg">
        <h1 className="mb-1 font-display text-xl font-bold text-rose-dark">Espace propriétaire</h1>
